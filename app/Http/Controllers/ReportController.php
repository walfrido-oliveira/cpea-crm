...
class ReportController extends Controller
{
  ...
  public function report3(Request $request)
  {
    ...
    return $this->reportFactory($html, "Relatório Contatos Públicos dos Cliente-Empresa.xls");
  }
  ...
  public function report4(Request $request)
  {
    ...
    return $this->reportFactory($html, "Relatório Contatos dos Cliente-Empresa.xls");
  }
