<x-app-layout>
    <div class="py-6 index-directions">
        <div class="md:max-w-6xl lg:max-w-full mx-auto px-4">
            ...
            <div class="flex md:flex-row flex-col">
                ...
                <div class="w-full flex justify-end">
                    <div class="m-2 ">
                        <a class="btn-outline-info" href="{{ route('directions.create') }}" >{{ __('Cadastrar') }}</a>
                    </div>
                    <div class="m-2">
                        <button type="button" class="btn-outline-danger delete-directions" data-type="multiple">{{ __('Apagar') }}</button>
                    </div>
                </div>
            </div>
            ...
            <div class="py-2 my-2 bg-white rounded-lg min-h-screen">
                ...
                <div class="flex mt-4">
                    <table id="directions_table" class="table table-responsive md:table w-full">
                        @include('directions.filter-result', ['directions' => $directions, 'ascending' => $ascending, 'orderBy' => $orderBy])
                    </table>
                </div>
    ...
    <x-modal title="{{ __('Excluir Diretoria') }}"
             msg="{{ __('Deseja realmente apagar esse Diretoria?') }}"
    ...
    <script>
        window.addEventListener("load", function() {
            var filterCallback = function (event) {
                ...
                var url = "{!! route('directions.filter') !!}";
                ...
                ajax.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        document.getElementById("directions_table").innerHTML = resp.filter_result;
            ...
            function eventsFilterCallback() {
                ...
                document.querySelectorAll("#directions_table thead [data-name]").forEach(item => {
