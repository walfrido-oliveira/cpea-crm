        ...
        <div class="md:max-w-6xl lg:max-w-full mx-auto px-4">
            <div class="flex md:flex-row flex-col">
                ...
                <div class="w-full flex justify-end">
                    ...
                    <div class="m-2">
                        <a class="btn-outline-warning" href="{{ route('employees.edit', ['employee' => $employee->id]) }}">{{ __('Editar') }}</a>
                    </div>
                    <div class="m-2">
                        <button type="button" class="btn-outline-danger delete-employee" id="employee_delete" data-toggle="modal" data-target="#delete_modal" data-id="{{ $employee->id }}">{{ __('Apagar') }}</button>
                    </div>
                </div>
            </div>
