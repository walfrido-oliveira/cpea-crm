<x-app-layout>
            ...
            <div class="py-2 my-2 bg-white rounded-lg min-h-screen">
                ...
                <div class="flex mt-4">
                    <table id="customers_table" class="table table-responsive md:table w-full">
                        @include('customers.companies.filter-result', ['customers' => $customers, 'ascending' => $ascending, 'orderBy' => $orderBy])
                    </table>
                </div>
    ...
    <x-modal title="{{ __('Excluir Empresas/Filiais') }}"
             msg="{{ __('Deseja realmente apagar esse Empresas/Filiais?') }}"
    ...
    <script>
        window.addEventListener("load", function() {
            var filterCallback = function (event) {
                ...
                var url = "{!! route('customers.companies.filter') !!}";
