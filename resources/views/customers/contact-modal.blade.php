<div class="fixed z-10 inset-0 overflow-y-auto hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true" id="contact_modal" data-id="0" data-row="">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                        ...
                        <div class="mt-2">
                            <div class="flex flex-wrap mt-2 w-full">
                                <div class="w-full pr-3 mb-6 md:mb-1">
                                    <x-jet-label for="general_contact_type_id" value="{{ __('Tipo') }}" />
                                    <x-custom-select :options="$generalContactTypes" value="" name="general_contact_type_id" id="general_contact_type_id" class="mt-1"/>
                                </div>
                                <div class="w-full pr-3 mb-6 md:mb-1">
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button type="button" id="confirm_contact_modal" class="btn-confirm" data-index="" data-row="">
                    Confirmar
                </button>
                <button type="button" id="cancel_contact_modal" class="btn-cancel" >
                    Cancelar
                </button>
            </div>
        </div>
