            ...
            <form method="POST" action="{{ route('customers.conversations.item.store') }}">
                ...
                <div class="py-2 my-2 bg-white rounded-lg">
                    ...
                    <div class="flex flex-wrap mx-4 px-3 py-2 mt-0">
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <x-jet-input id="cpea_linked_id" class="form-control block mt-1 w-full" type="text" name="cpea_linked_id" maxlength="255" autofocus autocomplete="cpea_linked_id" value="{{ old('cpea_linked_id') }}"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="py-2 my-2 bg-white rounded-lg" x-data="showFieldsSchedule()">
                    <div class="flex mx-4 px-3 py-2 mt-4">
                        <h2 class="w-full px-3 mb-6 md:mb-0">Agendar Reunião</h2>
