    ...
    <div class="md:max-w-6xl lg:max-w-full mx-auto px-4">
      <div class="flex md:flex-row flex-col">
        <div class="w-full flex items-center">
          <h1>{{ $conversationItem->conversation->customer->name }} - {{ __("Conversa") }} ({{
            str_pad($conversationItem->conversation->id, 5, 0, STR_PAD_LEFT) }})</h1>
        </div>
        ...
        <div class="mx-4 px-3 py-2 mt-4">
          ...
          <div class="flex flex-wrap">
            ...
            <div class="w-full md:w-1/2">
              <p class="text-gray-500 font-bold">{{ $conversationItem->conversation->customer ?
                $conversationItem->conversation->customer->name : '-' }}</p>
            </div>
          </div>
          ...
          <div class="flex flex-wrap">
            ...
            <div class="w-full md:w-1/2">
              <p class="text-gray-500 font-bold">{{ $conversationItem->conversation->customer->customer ?
                $conversationItem->conversation->customer->customer->name : '-' }}</p>
            </div>
          </div>
          ...
          <div class="flex flex-wrap">
            ...
            <div class="w-full md:w-1/2">
              <p class="text-gray-500 font-bold">{{ str_pad($conversationItem->conversation->id, 5, 0, STR_PAD_LEFT) }}
              </p>
            </div>
          </div>
          ...
          <div class="flex flex-wrap">
            ...
            <div class="w-full md:w-1/2">
              <p class="text-gray-500 font-bold">
                {{ $conversationItem->user ? $conversationItem->user->full_name : '-' }} -
                {{ $conversationItem->updated_at->format('d/m/Y H:i:s')}}
              </p>
            </div>
          </div>
      ...
      <div class="py-2 my-2 bg-white rounded-lg">
        <div class="mx-4 px-3 py-2 mt-4">
          ...
          <div class="flex flex-wrap">
            ...
            <div class="w-full md:w-1/2">
              <p class="text-gray-500 font-bold">{{ $conversationItem->detailedContact ?
                $conversationItem->detailedContact->contact : '-' }}</p>
            </div>
          </div>
          ...
          <div class="flex flex-wrap">
            ...
            <div class="w-full md:w-1/2">
              <p class="text-gray-500 font-bold">{{ $conversationItem->etapa ? $conversationItem->etapa->name : '-' }}
              </p>
            </div>
          </div>
          ...
          <div class="flex flex-wrap">
            <div class="w-full md:w-2/12">
              <p class="font-bold">{{ __('Probabilidade') }}</p>
            </div>
            <div class="w-full md:w-1/2">
              <p class="text-gray-500 font-bold">{{ $conversationItem->probability ? $conversationItem->probability :
                '-' }}</p>
            </div>
          </div>
          ...
          <div class="flex flex-wrap">
            ...
            <div class="w-full md:w-1/2">
              <p class="text-gray-500 font-bold">{{ $conversationItem->cpea_linked_id ?
                $conversationItem->cpea_linked_id : '-' }}</p>
            </div>
          </div>
          @endif
          ...
          <div class="flex flex-wrap">
            ...
            <div class="w-full md:w-1/2">
              <p class="text-gray-500 font-bold">{{ $conversationItem->conversation->cpea_id ?
                $conversationItem->conversation->cpea_id : '-' }}</p>
            </div>
          </div>
          ...
          <div class="flex flex-wrap">
            ...
            <div class="w-full md:w-1/2">
              <p class="text-gray-500 font-bold">{{ $conversationItem->department ? $conversationItem->department->name : '-' }}</p>
            </div>
          </div>
          @endif
          ...
          <div class="flex flex-wrap" x-data="showInfosProducts()">
            ...
            <div class="w-full md:w-1/2 flex">
              <div class="w-auto mr-4">
                ...
                <p class="text-gray-500 font-bold" @if($key> 2)
                  x-show="isOpen()"
              ...
              <div class="w-full md:w-2/12">
                ...
                <button class="btn-transition-primary" type="button" id="show_all_products"
                  @click="isOpen() ? close() : show();">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" :class="{ 'rotate-180': isOpen(), 'rotate-0': !isOpen() }"
        ...
        <div class="mx-4 px-3 py-2 mt-4">
          ...
          <div class="flex flex-wrap" x-data="showInfosAttachments()">
            <div class="w-full flex">
                ...
                <table class="table-attachments table md:table w-full">
                  ...
                  <tbody>
                    ...
                    <tr @if($key> 3) x-show="isOpen()"
                      ...
                      <td>
                        <a class="text-green-600 underline font-bold" href="{{ url($attachment->url) }}"
              ...
              <div class="w-full md:w-2/12">
                <button class="btn-transition-primary" type="button" id="show_all_attachments"
                  @click="isOpen() ? close() : show();">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" :class="{ 'rotate-180': isOpen(), 'rotate-0': !isOpen() }"
                    class="h-6 w-6 inline">
        ...
        <div class="mx-4 px-3 py-2 mt-4">
          ...
          <div class="flex flex-wrap" x-data="showInfosValues()">
            <div class="w-full flex">
              ...
              <div class="w-full md:w-2/12">
                <button class="btn-transition-primary" type="button" id="show_all_values"
                  @click="isOpen() ? close() : show();">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" :class="{ 'rotate-180': isOpen(), 'rotate-0': !isOpen() }"
                    class="h-6 w-6 inline">
      ...
      <div class="py-2 my-2 bg-white rounded-lg">
        <div class="mx-4 px-3 py-2 mt-4">
          ...
          <div class="flex flex-wrap">
            ...
            <div class="w-full md:w-1/2">
              <p class="text-gray-500 font-bold">{{ $conversationItem->schedule_name ? $conversationItem->schedule_name
                : '-' }}</p>
            </div>
          </div>
          ...
          <div class="flex flex-wrap">
            ...
            <div class="w-full md:w-1/2">
              <p class="text-gray-500 font-bold">{{ $conversationItem->meeting_form ?
                __($conversationItem->meeting_form) : '-' }}</p>
            </div>
          </div>
          ...
          <div class="flex flex-wrap">
            ...
            <div class="w-full md:w-1/2">
              <p class="text-gray-500 font-bold">{{ $conversationItem->schedule_at ?
                $conversationItem->schedule_at->format('d/m/Y H:i:s') : "-" }}</p>
            </div>
          </div>
          ...
          <div class="flex flex-wrap">
            ...
            <div class="w-full md:w-1/2">
              <p class="text-gray-500 font-bold">{{ $conversationItem->schedule_end ?
                $conversationItem->schedule_end->format('d/m/Y H:i:s') : "-" }}</p>
            </div>
          </div>
          ...
          <div class="flex flex-wrap">
            ...
            <div class="w-full md:w-1/2">
              <p class="text-gray-500 font-bold">{{ $conversationItem->organizer ?
                ($conversationItem->organizer->full_name . ' | ' . $conversationItem->organizer->email) : '-' }}</p>
            </div>
          </div>
          ...
          <div class="flex flex-wrap">
            ...
            <div class="w-full">
              <p class="text-gray-500 font-bold">{!! $conversationItem->schedule_details ?
                $conversationItem->schedule_details : '-' !!}</p>
            </div>
          </div>
        </div>
