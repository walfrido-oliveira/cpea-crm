            ...
            <form method="POST" action="{{ route('customers.conversations.item.store') }}" enctype="multipart/form-data">
                ...
                <div class="flex md:flex-row flex-col">
                    ...
                    <div class="w-full flex justify-end">
                        ...
                        <div class="m-2">
                            <a href="{{ route('home') }}" class="btn-outline-danger">{{ __('Cancelar') }}</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex flex-wrap mx-4 px-3 py-2 mt-4">
                        ...
                        <div class="w-full md:w-1/2 justify-end flex text-center" style="min-height: 54px">
                            <div>
                                ...
                                <h2 class="px-3 mb-6 md:mb-0 text-green-600" style="font-size: 2rem !important;" id="id_cpea_value"></h2>
                            </div>
                        </div>
                    </div>
                ...
                <div class="py-2 my-2 bg-white rounded-lg conversation_fields">
                    ...
                    <div class="flex flex-wrap mx-4 px-3 py-2 mt-0">
                        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                            ...
                            <input type="hidden" name="customer_value" id="customer_value">
                            <x-custom-select :options="$customers" value="{{ old('customer_id') }}" required name="customer_id" id="customer_id" class="mt-1"/>
                        </div>
                        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                            <x-jet-label for="customer_parent_id" value="{{ __('Empresa') }}" />
                            <x-custom-select :options="[]" value="{{ old('customer_parent_id') }}" name="customer_parent_id" id="customer_parent_id" class="mt-1"/>
                        </div>
                        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                            <x-jet-label for="conversation_id" value="{{ __('Cód. da Interação') }}" />
                            <x-custom-select :options="[]" value="{{ old('conversation_id') }}"  name="conversation_id" id="conversation_id" class="mt-1"/>
                        </div>
                    </div>
                    <div class="flex flex-wrap mx-4 px-3 py-2 mt-0">
                    ...
                    <div class="flex flex-wrap mx-4 px-3 py-2 mt-0">
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <x-custom-select :options="[]" value="{{ old('detailed_contact_id') }}" required name="detailed_contact_id" id="detailed_contact_id" class="mt-1"/>
                        </div>
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            <x-jet-label for="products" value="{{ __('Produtos') }}"/>
                            <x-custom-multi-select multiple :options="$products" name="products[]" id="products" :value="[]" select-class="form-input" class="mt-1" no-filter="no-filter" />
                        </div>
                    </div>
