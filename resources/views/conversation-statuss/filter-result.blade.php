...
<tbody id="conversation_status_table_content">
    @forelse ($conversationStatuss as $key => $conversationStatus)
        <tr>
            <td>
                <input class="form-checkbox conversation-statuss-url" type="checkbox" name="conversation-statuss[{{ $conversationStatus->id }}]" value="{!! route('conversation-statuss.destroy', ['conversation_status' => $conversationStatus->id]) !!}">
            </td>
            <td>
            ...
            <td>
                ...
                <button class="btn-transition-danger delete-conversation-statuss" data-url="{!! route('conversation-statuss.destroy', ['conversation_status' => $conversationStatus->id]) !!}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
