<x-app-layout>
    <div class="py-6 create-conversation-status">
        <div class="md:max-w-6xl lg:max-w-full mx-auto px-4">
            <form method="POST" action="{{ route('conversation-statuss.store') }}">
                @csrf
                @method("POST")
                ...
                <div class="py-2 my-2 bg-white rounded-lg min-h-screen">
                    <div class="flex flex-wrap mx-4 px-3 py-2 mt-4">
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <x-custom-select :options="$types" value="{{ old('type') }}" name="type" id="type" class="mt-1"/>
                        </div>
                    </div>
                </div>
            </form>
