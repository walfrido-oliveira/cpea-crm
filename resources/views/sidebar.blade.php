...
<div class="md:flex flex-col md:flex-row sidebar md:min-h-screen">
    <div @click.away="open = false" class="flex flex-col w-full md:w-72 text-gray-700 dark-mode:text-gray-200 dark-mode:bg-gray-800 flex-shrink-0" x-data="{ open: false }">
      ...
      <nav :class="{'block': open, 'hidden': !open}" class="flex-grow md:block px-0 pb-4 md:pb-0 md:overflow-y-auto">
        ...
        <a class="@if(request()->routeIs('contact-types.index')) {{ 'active' }} @endif" href="{{ route('contact-types.index') }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            Tipo Contato
        ...
        <a class="@if(request()->routeIs('segments.index')) {{ 'active' }} @endif" href="{{ route('segments.index') }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            Segmentos
        ...
        <a class="@if(request()->routeIs('sectors.index')) {{ 'active' }} @endif" href="{{ route('sectors.index') }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            Setores
        ...
        <a class="@if(request()->routeIs('prospecting-statuss.index')) {{ 'active' }} @endif" href="{{ route('prospecting-statuss.index') }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            Status Prospecção
        ...
        <a class="@if(request()->routeIs('proposed-statuss.index')) {{ 'active' }} @endif" href="{{ route('proposed-statuss.index') }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            Status Proposta
        ...
        <a class="@if(request()->routeIs('project-statuss.index')) {{ 'active' }} @endif" href="{{ route('project-statuss.index') }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            Status Projeto
